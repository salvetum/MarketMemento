...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const translations = {
        tr: {
            ...
            techBootstrap: 'Arayüz bileşenleri ve simgeler', techPapa: 'CSV dosyalarını ayrıştırma', techApex: 'Etkileşimli veri grafikleri', techExport: 'PNG ve PDF rapor çıktıları', techRates: 'Para birimi referans kurları', techBrowser: 'Yerel saklama ve çevrimdışı çalışma',
        ...
        en: {
            ...
            techBootstrap: 'Interface components and icons', techPapa: 'CSV file parsing', techApex: 'Interactive data charts', techExport: 'PNG and PDF report exports', techRates: 'Currency reference rates', techBrowser: 'Local storage and offline support',
